...
--
-- Host: localhost:3306
-- Generation Time: Dec 11, 2024 at 07:12 AM
...
('42a8cad7-6736-11ee-909d-0c7a158e4469', 'instamojo', '{\"gateway\":\"instamojo\",\"mode\":\"live\",\"status\":0,\"client_id\":\"\",\"client_secret\":\"\"}', '{\"gateway\":\"instamojo\",\"mode\":\"test\",\"status\":0,\"client_id\":\"\",\"client_secret\":\"\"}', 'payment_config', 'test', 0, '2024-10-16 10:10:08', '2024-10-16 10:10:08', NULL),
...
('a40991e4-6735-11ee-909d-0c7a158e4469', 'phonepe', '{\"gateway\":\"phonepe\",\"mode\":\"live\",\"status\":0,\"merchant_id\":\"\",\"salt_Key\":\"\",\"salt_index\":\"\"}', '{\"gateway\":\"phonepe\",\"mode\":\"test\",\"status\":0,\"merchant_id\":\"\",\"salt_Key\":\"\",\"salt_index\":\"\"}', 'payment_config', 'test', 0, '2024-10-16 10:10:08', '2024-10-16 10:10:08', NULL),
...
('cc90e5f2-6735-11ee-909d-0c7a158e4469', 'cashfree', '{\"gateway\":\"cashfree\",\"mode\":\"live\",\"status\":0,\"client_id\":\"\",\"client_secret\":\"\"}', '{\"gateway\":\"cashfree\",\"mode\":\"test\",\"status\":0,\"client_id\":\"\",\"client_secret\":\"\"}', 'payment_config', 'test', 0, '2024-10-16 10:10:08', '2024-10-16 10:10:08', NULL),
...
CREATE TABLE `blogs` (
  ...
  `publish_date` datetime NOT NULL DEFAULT '2024-12-11 13:09:15',
...
CREATE TABLE `bonuses` (
  ...
  `bonus_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(111, 'push_notification_service_file_content', '', NULL, NULL),
(112, 'blog_section_status', '0', NULL, NULL),
(113, 'blog_intro_title', 'Blog', NULL, NULL),
(114, 'blog_intro_subtitle', 'Stay updated with the latest tips, news, and insights about digital wallets, payments, and financial technology. Explore expert advice, industry trends, and innovations to enhance your digital wallet experience.', NULL, NULL),
(115, 'blog_category_priority_type', 'latest', NULL, NULL),
(116, 'blog_priority_type', 'latest', NULL, NULL),
(117, 'faq_section_status', '0', NULL, NULL),
(118, 'faq_intro_title', 'Frequently Asked Questions (FAQ)', NULL, NULL),
(119, 'faq_intro_subtitle', 'Find quick answers to common questions about our digital wallet, including features, security, payments, and account management', NULL, NULL),
(120, 'faq_category_priority_type', 'latest', NULL, NULL),
(121, 'faq_priority_type', 'latest', NULL, NULL);
...
CREATE TABLE `merchants` (
  ...
  `merchant_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(298, '2024_11_25_100547_create_faqs_table', 12),
(299, '2024_11_25_100656_create_blogs_table', 12),
(300, '2024_11_27_170730_create_blog_categories_table', 12),
(301, '2024_11_30_155612_create_faq_categories_table', 12),
(302, '2024_12_03_114540_add_slug_in_blogs', 12),
(303, '2024_12_03_114849_add_slug_in_blog_categories', 12),
(304, '2024_12_10_191010_add_is_published_in_blogs', 12);
...
CREATE TABLE `news_letters` (
  `id` bigint UNSIGNED NOT NULL,
  `email` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Subscribers email',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `payment_records` (
  ...
  `amount` double(14,2) NOT NULL DEFAULT '0.00',
  `callback` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_paid` tinyint NOT NULL DEFAULT '0' COMMENT '0=unpaid, 1=paid',
...
CREATE TABLE `transactions` (
  `id` bigint UNSIGNED NOT NULL,
  `user_id` bigint NOT NULL,
  `ref_trans_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `transaction_limits` (
  ...
  `this_months_count` int NOT NULL DEFAULT '0',
  `this_months_amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'add_money, send_money, cash_out, send_money_request, withdraw_request',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `dial_country_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `identification_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '[]',
...
CREATE TABLE `withdraw_requests` (
  ...
  `is_paid` tinyint(1) NOT NULL DEFAULT '0',
  `sender_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `withdrawal_method_id` bigint DEFAULT NULL,
