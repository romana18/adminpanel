    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'blog', 'as' => 'blog.'], function () {
            ...
            Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
                ...
                Route::delete('delete/{id}', [BlogCategoryController::class, 'delete'])->name('delete');
        ...
        Route::group(['prefix' => 'faq', 'as' => 'faq.'], function () {
            ...
            Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
                ...
                Route::delete('delete/{id}', [FAQCategoryController::class, 'delete'])->name('delete');
                Route::put('update/{id}', [FAQCategoryController::class, 'update'])->name('update');
