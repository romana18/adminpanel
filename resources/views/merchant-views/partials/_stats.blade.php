<div class="col-sm-6 col-md-4">
    <a class="dashboard--card h-100" href="#">
        ...
        <img src="{{asset('assets/admin/img/media/dollar-1.png')}}" class="dashboard-icon"
             alt="{{translate('image')}}">
    </a>
</div>
...
<div class="col-sm-6 col-md-4">
    <a class="dashboard--card h-100" href="#">
        ...
        <img src="{{asset('assets/admin/img/media/dollar-4.png')}}" class="dashboard-icon"
             alt="{{translate('image')}}">
    </a>
</div>
...
<div class="col-sm-6 col-md-4">
    <a class="dashboard--card h-100" href="#">
        ...
        <img src="{{asset('assets/admin/img/media/dollar-2.png')}}" class="dashboard-icon"
             alt="{{translate('image')}}">
    </a>
</div>
