                            ...
                            <div class="row gy-4 align-items-center">
                                <div class="col-lg-8">
                                    <div class="how-it-works-img-wrap">
                                        <div class="how-it-works-img bg-contain"
                                            {{ $index === 0 ? 'data-aos=fade-right data-aos-duration=1000 data-aos-delay=300' : '' }}
                                            data-bg-img="{{ asset('public/assets/landing/img/media/how-works-img-bg.png') }}">
                                            <img width="524"
                                ...
                                <div class="col-lg-4">
                                    <div class="how-it-works-content"
                                        {{ $index === 0 ? 'data-aos=fade-right data-aos-duration=1000 data-aos-delay=500' : '' }}>
                                        <h3>{!! $item['title'] !!}</h3>
                                        <hr class="w-75">
