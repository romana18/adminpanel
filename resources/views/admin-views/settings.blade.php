    ...
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-4 justify-content-between">
            <div class="d-flex align-items-center gap-3">
                <img width="24" src="{{asset('assets/admin/img/media/settings.png')}}" alt="{{ translate('settings') }}">
                <h2 class="mb-0 text-capitalize">{{translate('Settings')}}</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                @csrf
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-title mb-0"><i class="tio-info"></i>{{ translate('Basic information') }}</h5>
                        </div>
                ...
                <div id="passwordDiv" class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{ translate('Change your password') }}</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" id="savePasswordButton" class="btn btn-primary">{{ translate('Save Changes') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
