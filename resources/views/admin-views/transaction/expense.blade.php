    ...
    <div class="content container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
            <div class="d-flex align-items-center gap-3">
                <img width="22" src="{{asset('assets/admin/img/media/lending.png')}}" alt="{{ translate('expense') }}">
        ...
        <div class="row g-2">
            <div class="col-sm-6 col-xl-4">
                <div class="dashboard--card h-100">
                    ...
                    <img src="{{asset('assets/admin/img/media/dollar-2.png')}}" class="dashboard-icon" alt="{{ translate('total_expense') }}">
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="dashboard--card h-100">
                    ...
                    <img src="{{asset('assets/admin/img/media/dollar-3.png')}}" class="dashboard-icon" alt="{{ translate('total_user') }}">
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xl-4">
                <div class="dashboard--card h-100">
                    ...
                    <img src="{{asset('assets/admin/img/media/dollar-4.png')}}" class="dashboard-icon" alt="{{ translate('total_transaction') }}">
                </div>
            </div>
        </div>
