...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/agent.png')}}" alt="{{ translate('user') }}">
                    ...
                    <div class="card-body">
                        <div>
                            <div class="dashboard--card h-100">
                                ...
                                <img src="{{ asset('assets/admin/img/media/dollar-1.png') }}" class="dashboard-icon" alt="{{ translate('dollar') }}">
                            </div>
                        </div>
                    </div>
                </div>
