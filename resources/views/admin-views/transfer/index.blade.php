...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/dollar-2.png')}}" alt="{{ translate('transfer') }}">
            ...
            ajax: {
                ...
                data: function (params) {
                    ...
                    if (receiver_type == null) {
                        Swal.fire({
                            type: 'warning',
                            title: '{{ translate("No Receiver Selected") }}!',
                            text: '{{ translate("Select_valid_receiver_type_first") }}',
