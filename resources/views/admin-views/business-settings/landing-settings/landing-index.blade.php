...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2">
            <img width="24" src="{{ asset('assets/admin/img/media/business-setup.png') }}"
        ...
        @if ($webPage == 'feature')
            ...
            <div class="d-flex justify-content-end gap-3 mb-3">
                <button type="button" class="btn btn-outline-primary d-flex gap-2 align-items-center"
                    data-toggle="modal" data-target="#section-view-modal-feature">Section View <i
                    ...
                    <form method="post" id="landing-info-title-status-form">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="input-label"
                                        for="feature_title">{{ translate('section_Title') }}</label>
                                    <input type="text" name="title" value="{{ $title }}" id="feature_title"
                                        class="form-control" placeholder="{{ translate('title') }}" required>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="height-50px width-50px"
                                                src="{{ Helpers::onErrorImage($item['image'], asset('storage/app/public/landing-page/feature') . '/' . $item['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/feature/') }}"
                                                alt="{{ translate('image') }}">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="table-actions">
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <button type="button"
                                                        class="action-btn btn btn-outline-primary edit-feature"
                                                        data-key="{{ $key }}">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                                        <h6 class="mb-1">{{ translate('Min Size for Better Resolution 200x434 px') }}
                                        </h6>
                                        <small>{{ translate('Image format : jpg, png, jpeg | Maximum size : 5MB') }}</small>
                                    </div>
                        ...
                        <table id="example"
                            ...
                            <tbody>
                                @foreach ($screenshots ?? [] as $key => $item)
                                    <tr>
                                        <td>
                                            <img class="max-width-180px max-height-180px"
                                                src="{{ Helpers::onErrorImage($item['image'], asset('storage/app/public/landing-page/screenshots') . '/' . $item['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/screenshots/') }}"
                                                alt="{{ translate('image') }}">
                                        </td>
                                        <td>
                                            <label class="switcher" for="welcome_status_{{ $key }}">
        ...
        @if ($webPage == 'why_choose_us')
            ...
            <div class="d-flex justify-content-end gap-3 mb-3">
                <button type="button" class="btn btn-outline-primary d-flex gap-2 align-items-center"
                    data-toggle="modal" data-target="#section-view-modal-why-choose-us">Section View <i
                        class="tio-document-text"></i></button>
                            ...
                            <div class="col-lg-6 mb-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ $title }}"
                                        id="choose_us_title" class="form-control"
                                        placeholder="{{ translate('title') }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($why_choose_us ?? [] as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="height-50px width-50px"
                                                src="{{ Helpers::onErrorImage($item['image'], asset('storage/app/public/landing-page/why-choose-us') . '/' . $item['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/why-choose-us/') }}"
                                                alt="{{ translate('image') }}">
                                        </td>
                                        <td>
                                            <label class="switcher" for="welcome_status_{{ $key }}">
                                        ...
                                        <td>
                                            <div class="table-actions d-flex gap-2">
                                                <button type="button"
                                                    class="action-btn btn btn-outline-primary edit-why-choose-us"
                                                    data-key="{{ $key }}">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </button>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="text-center mb-4">
                                    <img class="border rounded-10 mx-w300 w-100" id="viewer3"
                                        src="{{ Helpers::onErrorImage($agent_registration['banner'], asset('storage/app/public/landing-page/agent-registration') . '/' . $agent_registration['banner'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/agent-registration/') }}" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                            ...
                            <tbody>
                                @foreach ($how_it_works ?? [] as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img class="height-50px width-50px"
                                                src="{{ Helpers::onErrorImage($item['image'], asset('storage/app/public/landing-page/how-it-works') . '/' . $item['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/how-it-works/') }}"
                                                alt="{{ translate('image') }}">
                                        </td>
                                        <td>
                                            <label class="switcher" for="welcome_status_{{ $key }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center mb-4">
                                        <img class="border rounded-10 mx-w300 w-100" id="viewer1"
                                            src="{{ Helpers::onErrorImage($download['image'], asset('storage/app/public/landing-page/download-section') . '/' . $download['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/download-section/') }}"
                                            alt="{{ translate('image') }}" />
                                    </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="bg-light rounded p-3">
                                    <div class="form-group">
                                        ...
                                        <div class="text-center mb-4">
                                            <img class="mx-w160 w-100" id="viewer1"
                                                src="{{ Helpers::onErrorImage($business_download['download_icon'], asset('storage/app/public/landing-page/business-statistics') . '/' . $business_download['download_icon'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/business-statistics/') }}"
                                                alt="{{ translate('image') }}" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="text-center mb-4">
                                            <img class="mx-w160 w-100" id="viewer5"
                                                src="{{ Helpers::onErrorImage($business_download['review_icon'], asset('storage/app/public/landing-page/business-statistics') . '/' . $business_download['review_icon'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/business-statistics/') }}"
                                                alt="{{ translate('image') }}" />
                                        </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="bg-light rounded p-3">
                                    <div class="form-group">
                                        ...
                                        <div class="text-center mb-4">
                                            <img class="mx-w160 w-100" id="viewer4"
                                                src="{{ Helpers::onErrorImage($business_download['country_icon'], asset('storage/app/public/landing-page/business-statistics') . '/' . $business_download['country_icon'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/business-statistics/') }}"
                                                alt="{{ translate('image') }}" />
                                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="width-50px height-50px"
                                                src="{{ Helpers::onErrorImage($item['image'], asset('storage/app/public/landing-page/testimonial') . '/' . $item['image'], asset('assets/admin/img/900x400/img1.jpg'), 'landing-page/testimonial/') }}"
                                                alt="{{ translate('image') }}">
                                        </td>
                                        <td>{{ $item['name'] }}</td>
                                        <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" src="{{ asset('public/assets/landing/img/section-view/intro.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="section-view-modal-feature" tabindex="-1"
        aria-labelledby="section-view-modalLabel-feature" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" src="{{ asset('public/assets/landing/img/section-view/feature.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%"
                            src="{{ asset('public/assets/landing/img/section-view/screenshots.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="section-view-modal-why-choose-us" tabindex="-1"
        aria-labelledby="section-view-modalLabel-why-choose-us" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" src="{{ asset('public/assets/landing/img/section-view/choose-us.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" height="100%"
                            src="{{ asset('public/assets/landing/img/section-view/agent-reg.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" height="100%"
                            src="{{ asset('public/assets/landing/img/section-view/Frame.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" height="100%"
                            src="{{ asset('public/assets/landing/img/section-view/download.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" height="100%"
                            src="{{ asset('public/assets/landing/img/section-view/business-statistics.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-center">
                        <img width="100%" height="100%"
                            src="{{ asset('public/assets/landing/img/section-view/contact.png') }}"
                            alt="{{ translate('image') }}">
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $(".edit-feature").on("click", function() {
                ...
                if (selectedFeature) {
                    ...
                    $("#viewer3").attr("src", "{{ asset('storage/app/public/landing-page/feature') }}/" +
            ...
            $(".edit-screenshots").on("click", function() {
                ...
                if (selectedScreenshot) {
                    $("#viewer1").attr("src",
                        "{{ asset('storage/app/public/landing-page/screenshots') }}/" +
            ...
            $(".edit-why-choose-us").on("click", function() {
                ...
                if (selectedChooseUs) {
                    ...
                    $("#viewer3").attr("src",
                        "{{ asset('storage/app/public/landing-page/why-choose-us') }}/" +
                        selectedChooseUs.image);
            ...
            $(".edit-how-it-works").on("click", function() {
                ...
                if (selectedWorks) {
                    ...
                    $("#viewer3").attr("src",
                        "{{ asset('storage/app/public/landing-page/how-it-works') }}/" + selectedWorks
                        .image);
            ...
            $(".edit-testimonial").on("click", function() {
                ...
                if (selectedTestimonial) {
                    ...
                    $("#viewer3").attr("src",
                        "{{ asset('storage/app/public/landing-page/testimonial') }}/" +
