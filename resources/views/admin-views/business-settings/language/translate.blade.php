...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2">
            <img width="24" src="{{asset('assets/admin/img/media/languages.png')}}" alt="{{ translate('language') }}">
                                ...
                                <tr id="lang-{{$language['key']}}">
                                    ...
                                    <td style="width:50%">
                                        <div class="language-key">
                                            ...
                                            <label  style="white-space: initial; word-break: break-all; " >{{$language['key']}}</label>
                                        </div>
                                    </td>
                                    <td class="language-value" style="width:50%">
