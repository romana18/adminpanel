            ...
            <div class="card-body mt-3">
                ...
                <div class="d-flex flex-wrap gap-4">
                    <div class="">
                        ...
                        <div class="mt-4">
                            <img width="225" class="shadow-lg" src="{{asset('assets/admin/img/theme/theme_1.png')}}" alt="{{ translate('image') }}"/>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <div class="mt-4">
                            <img width="225" class="shadow-lg" src="{{asset('assets/admin/img/theme/theme_2.png')}}" alt="{{ translate('image') }}"/>
                        </div>
                    </div>
                </div>
            </div>
