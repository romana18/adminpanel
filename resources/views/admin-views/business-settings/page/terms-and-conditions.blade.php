...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/contact.png')}}" alt="{{ translate('terms_and_condition') }}">
            ...
            <div class="card-body">
                <form action="{{route('admin.pages.terms-and-conditions')}}" method="post" id="tnc-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div id="editor" class="min-h-200px">{!! $termsAndCondition['value']??'' !!}</div>
                                <textarea class="ckeditor form-control" name="tnc"  id="hiddenArea" style="display: none">{!! $termsAndCondition['value']??'' !!}</textarea>
                            </div>
                        </div>
                    </div>
