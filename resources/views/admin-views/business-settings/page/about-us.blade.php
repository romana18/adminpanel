...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 pb-2 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/info.png')}}" alt="{{ translate('media') }}">
            ...
            <div class="card-body">
                <form action="{{route('admin.pages.about-us')}}" method="post" enctype="multipart/form-data" id="tnc-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="text-center mb-4">
                                    ...
                                    src={{Helpers::onErrorImage($image['value'], asset('storage/app/public/about-us') . '/' . $image['value'], asset('assets/admin/img/900x400/img1.jpg'), 'about-us/')}}
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <div id="editor" class="min-h-200px">{!! $aboutUs['value']??'' !!}</div>
                                <textarea class="ckeditor form-control" name="about_us" id="hiddenArea" style="display: none">{!! $aboutUs['value'] ?? '' !!}</textarea>
                            </div>
                        </div>
                    </div>
