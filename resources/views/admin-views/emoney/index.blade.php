...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/dollar-2.png')}}" alt="{{ translate('emoney') }}">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-2 pb-1">
                    <h5 class="card-title d-flex align-items-center gap-2">
                        <img src="{{asset('assets/admin/img/media/business-analytics.png')}}" class="card-icon" alt="{{ translate('analytics') }}">
