...
@section('content')
    <div class="content container-fluid">
        <div class="d-flex align-items-center gap-3 mb-3">
            <img width="24" src="{{asset('assets/admin/img/media/notification.png')}}" alt="{{ translate('notification') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="text-center mt-3">
                            <img class="border rounded-10 mx-w400 w-100" id="viewer"
                                 src="{{asset('assets/admin/img/900x400/img1.jpg')}}" alt="{{ translate('image') }}"/>
                        </div>
                    </div>
