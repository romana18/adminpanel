<?php return array (
  ...
  'Subscribed Emails Table' => 'Subscribed Emails Table',
  'Search by Email' => 'Search by Email',
  'OK' => 'OK',
  'No Receiver Selected' => 'No Receiver Selected',
  'Ex: your subject' => 'Ex: your subject',
  'Ex: John Doe' => 'Ex: John Doe',
  'identity-image' => 'Identity-image',
  'identification-image' => 'Identification-image',
  'FAQ Page Setup' => 'FAQ Page Setup',
  'Blog Page' => 'Blog Page',
  'blog' => 'Blog',
  ...
  'Blog_List' => 'Blog List',
  'If you need to cancel an ongoing trip, please ensure the reason is valid (such as a safety concern, vehicle issue, or emergency). You can cancel the trip through the app by selecting the "Cancel Ride" opt' => 'If you need to cancel an ongoing trip  please ensure the reason is valid (such as a safety concern  vehicle issue  or emergency). You can cancel the trip through the app by selecting the  Cancel Ride  opt',
  'If you need to cancel an ongoing trip, please ensure the reason is valid (such as a safety concern, vehicle issue, or emergency). You can cancel the trip through the app by selecting the Cancel Ride opt' => 'If you need to cancel an ongoing trip  please ensure the reason is valid (such as a safety concern  vehicle issue  or emergency). You can cancel the trip through the app by selecting the Cancel Ride opt',
  'Currently no blog available in this list' => 'Currently no blog available in this list',
  'unavailable' => 'Unavailable',
  'Search no Result found' => 'Search no Result found',
  'Create New Blog' => 'Create New Blog',
  'Section_View' => 'Section View',
  'Enter SUb Title' => 'Enter SUb Title',
  'manage_Category' => 'Manage Category',
  'JPG, JPEG, PNG Less Than 5MB (Ratio 2:1)' => 'JPG  JPEG  PNG Less Than 5MB (Ratio 2:1)',
  'Thumbnail' => 'Thumbnail',
  'Type the description of your blog...' => 'Type the description of your blog...',
  'Bonus deleted successfully' => 'Bonus deleted successfully',
  'purpose' => 'Purpose',
  'linked_website' => 'Linked website',
  'date' => 'Date',
  'Arabic(SA)' => 'Arabic(SA)',
  ...
  'Turn Off' => 'Turn Off',
  'When its off the Driver will not be able to see any predefined Q & A.' => 'When its off the Driver will not be able to see any predefined Q & A.',
  'Do you want to turn OFF predefined Q & A for the driver' => 'Do you want to turn OFF predefined Q & A for the driver',
  'Turn On' => 'Turn On',
  'When its on the Driver will be able to see any predefined Q & A.' => 'When its on the Driver will be able to see any predefined Q & A.',
  'Do you want to turn ON predefined Q & A for the driver' => 'Do you want to turn ON predefined Q & A for the driver',
  'Once you turn off this Blog, It will not be visible to the Blog list for users.' => 'Once you turn off this Blog  It will not be visible to the Blog list for users.',
  'Are you sure to turn on the Blog Status?' => 'Are you sure to turn on the Blog Status ',
  'Once you turn on this Blog, It will be visible to the Blog list for users.' => 'Once you turn on this Blog  It will be visible to the Blog list for users.',
  ...
  'A To Z' => 'A To Z',
  'Show Most Clicked First' => 'Show Most Clicked First',
  'Popularity' => 'Popularity',
  'Show Latest First' => 'Show Latest First',
  'Blog sorting list' => 'Blog sorting list',
  'Blog List' => 'Blog List',
  'Categories' => 'Categories',
  'Blog Priority Setup' => 'Blog Priority Setup',
  'Once you turn on this Download App Button, It will be visible to the Blog Section for users.' => 'Once you turn on this Download App Button, It will be visible to the Blog Section for users.',
  'Once you turn off this Download App Button, It will not be visible to the Blog section for users.' => 'Once you turn off this Download App Button, It will not be visible to the Blog section for users.',
  'Are you sure to turn on the Download App Button Status' => 'Are you sure to turn on the Download App Button Status',
  'Are you sure to turn off the Download App Button Status?' => 'Are you sure to turn off the Download App Button Status ',
  'Background' => 'Background',
  'Sub title' => 'Sub title',
  'Updated successfully' => 'Updated successfully',
  'Blog Page Setup' => 'Blog Page Setup',
  'Priority Setup' => 'Priority Setup',
  'Blog' => 'Blog',
  'Not Now' => 'Not Now',
  'Once you turn off, it will not be visible to the Blog list for users' => 'Once you turn off, it will not be visible to the Blog list for users',
  'create_FAQ' => 'Create FAQ',
  'Currently no FAQ available in this list' => 'Currently no FAQ available in this list',
  'Select Category' => 'Select Category',
  'Create_FAQ' => 'Create FAQ',
  'FAQ sorting list' => 'FAQ sorting list',
  'FAQ List' => 'FAQ List',
  'FAQ Priority Setup' => 'FAQ Priority Setup',
  'Are you sure to turn off the Blog status' => 'Are you sure to turn off the Blog status',
  'FAQ_List' => 'FAQ List',
  'Once you turn on this FAQ, It will be visible to the FAQ list for users.' => 'Once you turn on this FAQ, It will be visible to the FAQ list for users.',
  'Once you turn on this Download App Button, It will be visible to the FAQ Section for users.' => 'Once you turn on this Download App Button, It will be visible to the FAQ Section for users.',
  'Are you sure to turn on the FAQ Status' => 'Are you sure to turn on the FAQ Status',
  'Enabling this option will make the faq section visible on the website for viewers' => 'Enabling this option will make the faq section visible on the website for viewers',
  'Once you turn off this FAQ, It will not be visible to the FAQ list for users.' => 'Once you turn off this FAQ, It will not be visible to the FAQ list for users.',
  'Are you sure to turn off the FAQ Status?' => 'Are you sure to turn off the FAQ Status ',
  ...
  'Are you sure to turn on the Blog status?' => 'Are you sure to turn on the Blog status ',
  'Once you turn off this Download App Button, It will not be visible to the FAQ section for users.' => 'Once you turn off this Download App Button, It will not be visible to the FAQ section for users.',
  'Okk' => 'Okk',
  ...
  'Here you can set FAQ question & answer' => 'Here you can set FAQ question & answer',
  ...
  'answer' => 'Answer',
  'question' => 'Question',
  'Once you turn off, it will not be visible to the FAQ list for users' => 'Once you turn off, it will not be visible to the FAQ list for users',
  'Are you sure to turn off the FAQ status' => 'Are you sure to turn off the FAQ status',
  'When you turn on this FAQ, It will be visible to the FAQ list for users' => 'When you turn on this FAQ, It will be visible to the FAQ list for users',
  'Status update successfully' => 'Status update successfully',
  'Are you sure to turn on the FAQ status?' => 'Are you sure to turn on the FAQ status ',
  'FAQ removed' => 'FAQ removed',
  ...
  'We are getting ready to answer all your questions. Come back soon for updates' => 'We are getting ready to answer all your questions. Come back soon for updates',
  'Sorry! Our FAQ is not yet available' => 'Sorry! Our FAQ is not yet available',
  'Faq' => 'Faq',
  'Google Play' => 'Google Play',
  'App Store' => 'App Store',
  'Search question or answer' => 'Search question or answer',
  ...
  'Search by title, description, category' => 'Search by title, description, category',
  'When the status is Off, the blog is saved as a draft and will not be displayed on the website. Setting it to On will publish it to the website.' => 'When the status is Off, the blog is saved as a draft and will not be displayed on the website. Setting it to On will publish it to the website.',
  'Search by title, description, writer' => 'Search by title, description, writer',
  'Blog deleted successfully.' => 'Blog deleted successfully.',
  'Once you delete it, this will permanently remove it from the Blog list and can not be accessed.' => 'Once you delete it, this will permanently remove it from the Blog list and can not be accessed.',
  'Are you sure you want to delete this Blog' => 'Are you sure you want to delete this Blog',
  'update & publish' => 'Update & publish',
  'Blog Edit' => 'Blog Edit',
  'Edit Draft Blog' => 'Edit Draft Blog',
  'Enabling this option will make the faq section visible on the both landing website and app for viewers' => 'Enabling this option will make the faq section visible on the both landing website and app for viewers',
  'Select a category from the dropdown menu to assign this FAQ. If no categories are available or want to add a new category, please add it from the Manage Category section.' => 'Select a category from the dropdown menu to assign this FAQ. If no categories are available or want to add a new category, please add it from the Manage Category section.',
  'Currently no FAQ Category available in this list' => 'Currently no FAQ Category available in this list',
  'Type answer here' => 'Type answer here',
  'Type question here' => 'Type question here',
  'Once you delete it, this will permanently remove it from the category list and can not be accessed' => 'Once you delete it, this will permanently remove it from the category list and can not be accessed',
  'Are you sure you want to delete this category' => 'Are you sure you want to delete this category',
  'search by question, answer' => 'Search by question, answer',
  'Ratio' => 'Ratio',
  'search by question, answer, category' => 'Search by question, answer, category',
  'Currently no Blog Category available in this list' => 'Currently no Blog Category available in this list',
  ...
  'Clear Draft' => 'Clear Draft',
  'Blog draft cleared successfully' => 'Blog draft cleared successfully',
  'To set up and display the blog list for an admin & website viewers, the admin manages blogs with sorting options, while the website provide user-friendly navigation with sorting.' => 'To set up and display the blog list for an admin & website viewers, the admin manages blogs with sorting options, while the website provide user-friendly navigation with sorting.',
  'To set up and display the FAQ list for an admin & website & app viewers, the admin manages FAQs with sorting options, while the website and app provide user-friendly navigation with sorting.' => 'To set up and display the FAQ list for an admin & website & app viewers, the admin manages FAQs with sorting options, while the website and app provide user-friendly navigation with sorting.',
  'This blog is not published yet. Edit option is disabled.' => 'This blog is not published yet. Edit option is disabled.',
  'To set up and display the category list for an admin and website viewers, the admin manages categories with sorting and visibility options, while the website provide user-friendly navigation with sorting.' => 'To set up and display the category list for an admin and website viewers, the admin manages categories with sorting and visibility options, while the website provide user-friendly navigation with sorting.',
  'To set up and display the category list for an admin, website & app viewers, the admin manages categories with sorting and visibility options, while the website and app provide user-friendly navigation with sorting.' => 'To set up and display the category list for an admin, website & app viewers, the admin manages categories with sorting and visibility options, while the website and app provide user-friendly navigation with sorting.',
  ...
  'Once you delete it, this will permanently remove it from the FAQ list and can not be accessed' => 'Once you delete it, this will permanently remove it from the FAQ list and can not be accessed',
  'Amrit is a secured and user-friendly digital wallet' => 'Amrit is a secured and user-friendly digital wallet',
  'Welcome to Amrit' => 'Welcome to Amrit',
