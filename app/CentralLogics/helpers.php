...
class helpers
{
    ...
    public static function send_transaction_notification($user_id, $amount, $transaction_type, $notificationType = null)
    {
        $user = User::find($user_id);
    ...
    public static function onErrorImage($data, $src, $errorSource ,$path)
    {
