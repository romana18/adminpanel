...
class BusinessSettingsController extends Controller
{
    ...
    public function businessIndex(): Factory|View|Application
    {
        ...
        $logo = Helpers::onErrorImage($logo, asset('storage/app/public/business') . '/' . $logo, asset('assets/admin/img/160x160/img2.jpg'), 'business/');
        $favicon = Helpers::onErrorImage($favicon, asset('storage/app/public/favicon') . '/' . $favicon, asset('assets/admin/img/160x160/img2.jpg'), 'favicon/');
        $landingPageLogo = Helpers::onErrorImage($landingPageLogo, asset('storage/app/public/business') . '/' . $landingPageLogo, asset('assets/admin/img/160x160/img2.jpg'), 'business/');
    ...
    public function paymentIndex(): Factory|View|Application
    {
        ...
        $dataValues = Setting::whereIn('settings_type', ['payment_config'])->whereIn('key_name', ['ssl_commerz', 'paypal', 'stripe', 'razor_pay', 'senang_pay', 'paystack', 'paymob_accept', 'flutterwave', 'bkash', 'mercadopago', 'phonepe', 'instamojo', 'cashfree'])->get();

        return view('admin-views.business-settings.payment-index', compact('publishedStatus', 'paymentUrl', 'dataValues'));
    }

//    private function insertNewAddonData()
//    {
...
//    }
    ...
    public function paymentConfigUpdate(Request $request): RedirectResponse
    {
        ...
        $validation = [
            'gateway' => 'required|in:ssl_commerz,paypal,stripe,razor_pay,senang_pay,paystack,paymob_accept,flutterwave,bkash,mercadopago,instamojo,phonepe,cashfree',
    ...
    public function updateBusinessSettingStatus(Request $request)
    {
    ...
    public function updateBusinessSettingData(Request $request)
    {
